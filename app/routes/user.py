...
@app.post("/users", response_model=UserBase, summary="Create a new user", description="Creates a new user with the provided data.")
...
@app.get("/users/{user_id}", response_model=UserBase, summary="Get user by ID", description="Fetches a user by their unique ID.")
